	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mUpdateFiles = new Runnable() {
			public void run() {
				...
				String title = res.getString(R.string.mupdf_picker_title_App_Ver_Dir);
				...
				adapter.clear();
				if (mParent != null)
					adapter.add(new ChoosePDFItem(ChoosePDFItem.Type.PARENT, getString(R.string.mupdf_parent_directory)));
				for (File f : mDirs)
