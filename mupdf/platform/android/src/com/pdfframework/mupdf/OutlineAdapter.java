...
public class OutlineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		for (int i=0; i<level;i++)
			space += "   ";
		((TextView)v.findViewById(R.id.mupdf_title)).setText(space+mItems[position].title);
		((TextView)v.findViewById(R.id.mupdf_page)).setText(String.valueOf(mItems[position].page+1));
		return v;
	}
